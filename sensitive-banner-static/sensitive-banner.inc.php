						...
						<table style="height: 100%">
							...
							<tr>
								<td style="height: 1%" valign="top">
									<p><i>Liebe Leserinnen und Leser:</i> Verzeihen Sie die
									...
									<td id="WMDE_FR2015_Banner-fullform-wrapper">
										<table>
											...
											<tr class="frequency-options">
												<td colspan="2">
													<input checked="checked" class="amount-radio" id="interval_onetime"
											...
											<tr class="interval-options interval-hidden">
												<td colspan="2">
													<input name="interval" class="amount-radio" id="interval1" value="1"
														   type="radio">
													<label for="interval1" class="interval-label">monatlich</label>
												</td>
												<td colspan="2">
													<input name="interval" class="amount-radio" id="interval3" value="3"
														   type="radio">
													<label for="interval3"
											...
											<tr class="interval-options interval-hidden">
												<td colspan="2">
													<input name="interval" class="amount-radio" id="interval6" value="6"
														   type="radio">
											...
											<tr class="amount-options">
												...
												<td style="padding-right: 8px">
													<input class="amount-radio" name="betrag" id="amount_other" value=""
														   type="radio">
											...
											<tr>
												...
												<td colspan="2" style="padding:8px 8px 0 5px; text-align: right">
													<button id="btn-ppl" onclick="$('#zahlweise').val('PPL');">PayPal
													</button>
												</td>
											</tr>
											</tbody>
